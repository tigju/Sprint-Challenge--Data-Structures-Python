...
names_list1 = LinkedList()
names_list2 = LinkedList()
start_time1 = time.time()

# for name_1 in names_1:
#     names_list1.add_to_tail(name_1)

# for name_2 in names_2:
#     names_list2.add_to_tail(name_2)

# duplicates1.compare(names_list1, names_list2)
# end_time1 = time.time()
# print (f"\n{duplicates1.length} duplicates:\n\n{duplicates1.output_list()}\n\n")
